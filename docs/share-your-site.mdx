...
Simply add your url to the Canonic home page url (For example: https://www.canonic.com/#https://example.com) and the Canonic web app will open your url as soon as it loads. 
...
[Part 7 - Extra learning resources](/extra-learning-resources.mdx)